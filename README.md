...
## Overview
An automated, institutional-grade equity valuation terminal built in Python. This tool eliminates the "false precision" of static Excel models by dynamically pulling 10 years of historical financial data via the Yahoo Finance API to project a 5-year Base Case Discounted Cash Flow (DCF). 
